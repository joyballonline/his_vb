...
'　　（システム名）在庫計画システム
'　　（処理機能名）生産量確定指示
'    （フォームID）ZG230B_SeisanryouKakutei
'
'===============================================================================
'　履歴　名前　　　　　日　付       マーク      内容
'-------------------------------------------------------------------------------
...
Imports UtilMDL.MSG
Imports UtilMDL.DB
Public Class ZG230B_SeisanryouKakutei
    ...
    Private Const FORMTITLE_TEXT_FIX As String = "生産量確定指示"
    Private Const FORMTITLE_TEXT_UNFIX As String = "生産量確定解除指示"
    Private Const MODELABEL_TEXT_FIX As String = "確定"
    Private Const MODELABEL_TEXT_UNFIX As String = "確定解除"
    Private Const PGID As String = "ZG230B"
    ...
    Public Sub New(ByRef prmRefMsgHd As UtilMsgHandler, _
                   ...
                   ByVal prmForm As ZC110M_Menu, _
    ...
    '　フォームロードイベント
    '-------------------------------------------------------------------------------
    Private Sub ZG230B_SeisanryouKakutei_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub initForm()
        Try
            ...
            '今回実行情報の表示
            lblKonkaiKensu.Text = Format(_db.rmNullInt(_db.selectDB("select count(*) CNT from T21SEISANM", RS).Tables(RS).Rows(0)("CNT")), "#,##0")
