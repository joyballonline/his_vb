...
Imports UtilMDL.MSG
Imports UtilMDL.DB
Public Class ZG540B_SKeikakuKakutei
    ...
    Private Const FORMTITLE_TEXT_FIX As String = "生産計画確定指示"
    Private Const FORMTITLE_TEXT_UNFIX As String = "生産計画確定解除指示"
    Private Const MODELABEL_TEXT_FIX As String = "確定"
    Private Const MODELABEL_TEXT_UNFIX As String = "確定解除"
    Private Const PGID As String = "ZG540B"
    ...
    '　フォームロードイベント
    '-------------------------------------------------------------------------------
    Private Sub ZG540B_SKeikakuKakutei_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
