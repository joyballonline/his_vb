...
Partial Class MstAccount
    ...
    Private Sub InitializeComponent()
        ...
        Me.Dgv_Account.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.会社コード, Me.勘定科目コード, Me.勘定科目名称１, Me.勘定科目名称２, Me.勘定科目名称３, Me.会計用勘定科目コード, Me.備考, Me.有効区分, Me.更新者, Me.更新日})
