...
'
'   （機能名）          販売単価マスタ一覧
'   （クラス名）        frmM40F10_HanbaiTankaList
'   （処理機能名）      
'   （本MDL使用前提）   
'   （備考）         
'
...
Public Class frmM40F10_HanbaiTankaList
#Region "宣言"
    ...
    '汎用マスメン
    Private Const lM4010_DB_EXIST As Integer = 1                        'あり：登録済
    Private Const lM4010_DB_NONE As Integer = 0                         'なし：未登録

    'グリッド列№ 
    Private Const M4010_COLNO_SHOHINCODE As Integer = 0                             '商品コード
    Private Const M4010_COLNO_SHOHINNAME As Integer = 1                             '商品名
    Private Const M4010_COLNO_TORICODE As Integer = 2                               '取引先コード
    Private Const M4010_COLNO_TORINAME As Integer = 3                               '取引先名
    Private Const M4010_COLNO_TEKIYOKAISIDATE As Integer = 4                        '適用開始日
    Private Const M4010_COLNO_TEKIYOSHURYODATE As Integer = 5                       '適用終了日
    Private Const M4010_COLNO_HANBAITANKA As Integer = 6                            '販売単価
    Private Const M4010_COLNO_TOKUBAIKBN As Integer = 7                             '特売区分
    Private Const M4010_COLNO_TOKUBAIKBNNAME As Integer = 8                         '特売区分名
    Private Const M4010_COLNO_MEMO As Integer = 9                                   'メモ
    Private Const M4010_COLNO_UPDNM As Integer = 10                                 '更新者
    Private Const M4010_COLNO_UPDDT As Integer = 11                                 '更新日
    Private Const M4010_COLNO_MODFLG As Integer = 12                                '更新フラグ
    Private Const M4010_COLNO_HDSHOHINCODE As Integer = 13                          '変更前商品コード
    Private Const M4010_COLNO_HDTOKUBAIKBN As Integer = 14                          '変更前特売区分
    Private Const M4010_COLNO_HDTORICODE As Integer = 15                            '変更前取引先コード
    Private Const M4010_COLNO_HDTEKIYOKAISIDATE As Integer = 16                     '変更前適用開始日

    'グリッド列名 
    Private Const M4010_CCOL_SHOHINCODE As String = "cnShohinCode"                  '商品コード
    Private Const M4010_CCOL_SHOHINNAME As String = "cnShohinName"                  '商品名
    Private Const M4010_CCOL_TORICODE As String = "cnToriCode"                      '取引先コード
    Private Const M4010_CCOL_TORINAME As String = "cnToriName"                      '取引先名
    Private Const M4010_CCOL_TEKIYOKAISIDATE As String = "cnTekiyoKaisiDate"        '適用開始日
    Private Const M4010_CCOL_TEKIYOSHURYODATE As String = "cnTekiyoShuryoDate"      '適用終了日
    Private Const M4010_CCOL_HANBAITANKA As String = "cnHanbaiTanka"                '販売単価
    Private Const M4010_CCOL_TOKUBAIKBN As String = "cnTokubaiKbn"                  '特売区分
    Private Const M4010_CCOL_TOKUBAIKBNNAME As String = "cnTokubaiKbnName"          '特売区分名
    Private Const M4010_CCOL_MEMO As String = "cnMemo"                              'メモ
    Private Const M4010_CCOL_UPDNM As String = "cnUpdNm"                            '更新者
    Private Const M4010_CCOL_UPDDT As String = "cnUpdDt"                            '更新日
    Private Const M4010_CCOL_MODFLG As String = "cnModFlg"                          '更新フラグ
    Private Const M4010_CCOL_HDSHOHINCODE As String = "cnHideShohinCode"            '変更前商品コード
    Private Const M4010_CCOL_HDTOKUBAIKBN As String = "cnHideTokubaiKbn"            '変更前特売区分
    Private Const M4010_CCOL_HDTORICODE As String = "cnHideToriCode"                '変更前取引先コード
    Private Const M4010_CCOL_HDTEKIYOKAISIDATE As String = "cnHideTekiyoKaisiDate"  '変更前適用開始日

    'グリッドデータ名 
    Private Const M4010_DTCOL_SHOHINCODE As String = "dtShohinCode"                 '商品コード
    Private Const M4010_DTCOL_SHOHINNAME As String = "dtShohinName"                 '商品名
    Private Const M4010_DTCOL_TORICODE As String = "dtToriCode"                     '取引先コード
    Private Const M4010_DTCOL_TORINAME As String = "dtToriName"                     '取引先名
    Private Const M4010_DTCOL_TEKIYOKAISIDATE As String = "dtTekiyoKaisiDate"       '適用開始日
    Private Const M4010_DTCOL_TEKIYOSHURYODATE As String = "dtTekiyoShuryoDate"     '適用終了日
    Private Const M4010_DTCOL_HANBAITANKA As String = "dtHanbaiTanka"               '販売単価
    Private Const M4010_DTCOL_TOKUBAIKBN As String = "dtTokubaiKbn"                 '特売区分
    Private Const M4010_DTCOL_TOKUBAIKBNNAME As String = "dtTokubaiKbnName"         '特売区分名
    Private Const M4010_DTCOL_MEMO As String = "dtMemo"                             'メモ
    Private Const M4010_DTCOL_UPDNM As String = "dtUpdNm"                           '更新者
    Private Const M4010_DTCOL_UPDDT As String = "dtUpdDt"                           '更新日
    Private Const M4010_DTCOL_MODFLG As String = "dtModFlg"                         '更新フラグ
    Private Const M4010_DTCOL_HDSHOHINCODE As String = "dtHideShohinCode"           '変更前商品コード
    Private Const M4010_DTCOL_HDTOKUBAIKBN As String = "dtHideTokubaiKbn"           '変更前特売区分
    Private Const M4010_DTCOL_HDTORICODE As String = "dtHideToriCode"               '変更前取引先コード
    Private Const M4010_DTCOL_HDTEKIYOKAISIDATE As String = "dtHideTekiyoKaisiDate" '変更前適用開始日
    ...
    Private _TokubaiKbn As Integer
    ...
    Public Property tokubaiKbn() As Integer
        Get
            Return _TokubaiKbn
        End Get
...
#Region "フォームロード"
    ...
    '-------------------------------------------------------------------------------
    Private Sub frmM40F10_HanbaiTankaList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "CSV出力ボタン　クリック"
    ...
    Private Sub cmdSyuturyoku_Click(sender As Object, e As EventArgs) Handles cmdSyuturyoku.Click
        ...
        Try
            ...
            ' 初期選択するパスを設定する
            fbd.SelectedPath = result("販売単価マスタ出力先")
            ...
            Try
                CreateCsvM40(strPath, result("販売単価マスタCSVファイル名"), ds, editFile)
...
#Region "参照ボタンクリック"
    ...
    Private Sub cmdSansyou_Click(sender As Object, e As EventArgs) Handles cmdSansyou.Click
        ...
        _ShohinCode = dgvIchiran.Rows(idx).Cells(M4010_CCOL_SHOHINCODE).Value
        _TokubaiKbn = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TOKUBAIKBN).Value
        _ToriCode = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TORICODE).Value
        _TekiyoFrDT = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TEKIYOKAISIDATE).Value
        Dim openForm As Form = Nothing
        openForm = New frmM40F20_HanbaiTankaHosyu(_msgHd, _db, Me, CommonConst.MODE_InquiryStatus, _selectId, _ShohinCode, _TokubaiKbn, _ToriCode, _TekiyoFrDT)   '処理選択
        openForm.Show()
        Me.Hide()   ' 自分は隠れる
...
#Region "追加ボタンクリック"
    ...
    Private Sub cmdTuika_Click(sender As Object, e As EventArgs) Handles cmdTuika.Click
        ...
        Dim openForm As Form = Nothing
        openForm = New frmM40F20_HanbaiTankaHosyu(_msgHd, _db, Me, CommonConst.MODE_ADDNEW, _selectId, "", 0, "", "")   '処理選択
        openForm.Show()
        Me.Hide()   ' 自分は隠れる
...
#Region "複写新規ボタンクリック"
    ...
    Private Sub cmdFukusya_Click(sender As Object, e As EventArgs) Handles cmdFukusya.Click
        ...
        _TekiyoFrDT = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TEKIYOKAISIDATE).Value
        Dim openForm As Form = Nothing
        openForm = New frmM40F20_HanbaiTankaHosyu(_msgHd, _db, Me, CommonConst.MODE_ADDNEWCOPY, _selectId, _ShohinCode, _TokubaiKbn, _ToriCode, _TekiyoFrDT)   '処理選択
        openForm.Show()
        Me.Hide()   ' 自分は隠れる
...
#Region "変更ボタンクリック"
    ...
    Private Sub cmdHenkou_Click(sender As Object, e As EventArgs) Handles cmdHenkou.Click
        ...
        _TekiyoFrDT = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TEKIYOKAISIDATE).Value
        Dim openForm As Form = Nothing
        openForm = New frmM40F20_HanbaiTankaHosyu(_msgHd, _db, Me, CommonConst.MODE_EditStatus, _selectId, _ShohinCode, _TokubaiKbn, _ToriCode, _TekiyoFrDT)   '処理選択
        openForm.Show()
        Me.Hide()   ' 自分は隠れる
...
#Region "削除ボタンクリック"
    ...
    Private Sub cmdSakujo_Click(sender As Object, e As EventArgs) Handles cmdSakujo.Click
        ...
        _TekiyoFrDT = dgvIchiran.Rows(idx).Cells(M4010_CCOL_TEKIYOKAISIDATE).Value
        Dim openForm As Form = Nothing
        openForm = New frmM40F20_HanbaiTankaHosyu(_msgHd, _db, Me, CommonConst.MODE_DELETE, _selectId, _ShohinCode, _TokubaiKbn, _ToriCode, _TekiyoFrDT)   '処理選択
        openForm.Show()
        Me.Hide()   ' 自分は隠れる
...
#Region "プロシージャ"
    ...
    '-------------------------------------------------------------------------------
    '   CSV出力処理
    '   （処理概要）　販売単価マスタ一覧画面に表示されている内容をCSVファイルへ出力する
    ...
    '-------------------------------------------------------------------------------
    ''' <summary>
    ''' CSV出力処理（CreateCsvM40）
    ''' </summary>
    ''' <param name="prmOutDir"></param>
    ''' <param name="prmOutFile"></param>
    ''' <param name="prmDataSet"></param>
    ''' <param name="prmRefEditFileNm"></param>
    Private Sub CreateCsvM40(ByVal prmOutDir As String, ByVal prmOutFile As String, ByVal prmDataSet As DataSet, Optional ByRef prmRefEditFileNm As String = "")

        '出力データ生成
        Dim outStr As String = CreateCsvDataM40(prmDataSet)
    ...
    '-------------------------------------------------------------------------------
    '   CSV生成処理
    '   （処理概要）　販売単価マスタ一覧画面に表示されているデータを生成して返却する
    '   ●入力パラメタ   ：なし
    '   ●メソッド戻り値 ：CSV内容文字列
    '-------------------------------------------------------------------------------
    ''' <summary>
    ''' CSV生成処理（createCsvDataM40）
    ''' </summary>
    ''' <param name="prmDataSet"></param>
    Private Function CreateCsvDataM40(ByVal prmDataSet As DataSet) As String

        '形成
        Dim outStr As System.Text.StringBuilder = New System.Text.StringBuilder()
        With outStr
            'ヘッダ
            .Append("商品コード, 特売区分, 取引先コード, 適用開始日, 適用終了日, 販売単価, メモ, 更新者, 更新日" & ControlChars.NewLine)
            ...
            For i As Integer = 0 To prmDataSet.Tables(RS).Rows.Count - 1
                ...
                .Append("" & EnclosedItemDoubleQuotes(_db.rmNullStr(t.Rows(i)("dtTokubaiKbn"))) & ",")
                ...
                .Append("" & EnclosedItemDoubleQuotes(_db.rmNullStr(t.Rows(i)("dtHanbaiTanka"))) & ",")
        ...
        CreateCsvDataM40 = outStr.ToString
    ...
    '-------------------------------------------------------------------------------
    '　一覧表示
    '   （処理概要）入力された条件に該当する販売単価マスタデータを取得する
    '-------------------------------------------------------------------------------
    Private Sub Edit_frmM40F10_Ichiran()
        ...
        Try
            Dim sql As String = ""
            sql = "Select "
            sql = sql & N & "  sp.商品コード        " & M4010_DTCOL_SHOHINCODE        ' 0：商品コード
            sql = sql & N & ",  g.商品名            " & M4010_DTCOL_SHOHINNAME        ' 1：商品名
            sql = sql & N & ", sp.取引先コード      " & M4010_DTCOL_TORICODE          ' 2：取引先コード
            sql = sql & N & ", (Select Case sp.取引先コード WHEN '" & TORICODE_ALL & "' THEN '' "
            sql = sql & N & "                                                           ELSE c.取引先名 END) " & M4010_DTCOL_TORINAME    ' 3：取引先名
            sql = sql & N & ", sp.適用開始日        " & M4010_DTCOL_TEKIYOKAISIDATE   ' 4：適用開始日
            sql = sql & N & ", sp.適用終了日        " & M4010_DTCOL_TEKIYOSHURYODATE  ' 5：適用終了日
            sql = sql & N & ", TO_CHAR(sp.販売単価, '99,999,999.99')          " & M4010_DTCOL_HANBAITANKA       ' 6：販売単価
            sql = sql & N & ", sp.特売区分          " & M4010_DTCOL_TOKUBAIKBN        ' 7：特売区分
            sql = sql & N & ", (Select Case sp.特売区分 WHEN " & TOKUBAIKBN_TOKUBAI & " THEN True "
            sql = sql & N & "                                                           ELSE False END) " & M4010_DTCOL_TOKUBAIKBNNAME    ' 8：特売区分
            sql = sql & N & ", sp.メモ              " & M4010_DTCOL_MEMO              ' 9：メモ
            sql = sql & N & ", u.氏名            " & M4010_DTCOL_UPDNM                ' 10：更新者
            sql = sql & N & ", TO_CHAR(sp.更新日, 'YYYY/MM/DD HH24:MI') " & M4010_DTCOL_UPDDT   ' 11：更新日時
            sql = sql & N & ", '0'               " & M4010_DTCOL_MODFLG               ' 12：更新フラグ
            sql = sql & N & ", sp.商品コード        " & M4010_DTCOL_HDSHOHINCODE      ' 13：変更前商品コード
            sql = sql & N & ", sp.特売区分          " & M4010_DTCOL_HDTOKUBAIKBN      ' 14：変更前特売区分
            sql = sql & N & ", sp.取引先コード      " & M4010_DTCOL_HDTORICODE        ' 15：変更前取引先コード
            sql = sql & N & ", sp.適用開始日        " & M4010_DTCOL_HDTEKIYOKAISIDATE ' 16：変更前適用開始日
            ...
            sql = sql & N & " WHERE sp.会社コード  = '" & frmC01F10_Login.loginValue.BumonCD & "'"
            sql = sql & N & makeLikeSql()
            sql = sql & N & " ORDER BY " & M4010_DTCOL_SHOHINCODE & ", " & M4010_DTCOL_TOKUBAIKBN & ", " & M4010_DTCOL_TORICODE & ", " & M4010_DTCOL_TEKIYOKAISIDATE
    ...
    Private Sub Init_Form()
        ...
        Me.rboTokubai.Checked = False
        Me.rboTokubaiIgai.Checked = False
    ...
    Function makeLikeSql() As String
        ...
        termsSql += " and ( sp.商品コード like  '" & shohinCode & "%' "
        termsSql += " and    g.商品名 like  '%" & shohinName & "%' "
        termsSql += " and   sp.取引先コード like  '" & toriCode & "%' "
        If toriName <> "" Then
            termsSql += " and    c.取引先名 like  '%" & toriName & "%' "
        End If
        termsSql += " )"
        If dtpKijunDt.Value <> Nothing Then
            termsSql = termsSql & N & " and (sp.適用開始日 <= '" & Me.dtpKijunDt.Text & "' "
            termsSql = termsSql & N & " and  sp.適用終了日 >= '" & Me.dtpKijunDt.Text & "') "
        End If
        If rboTokubai.Checked Then
            termsSql = termsSql & N & " and sp.特売区分 = " & TOKUBAIKBN_TOKUBAI
        End If
        If rboTokubaiIgai.Checked Then
            termsSql = termsSql & N & " and sp.特売区分 = " & TOKUBAIKBN_IGAI
        End If
    ...
    Private Sub frmM40F10_HanbaiTankaList_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ...
        '検索データ表示
        Call Edit_frmM40F10_Ichiran()

        '保守画面から戻ってきたときの画面遷移前選択行への位置づけ
        If _ShohinCode = String.Empty Then
            If dgvIchiran.Rows.Count <> 0 Then
                dgvIchiran.CurrentCell = dgvIchiran.Rows(0).Cells(M4010_COLNO_TORICODE)
            End If
        Else
            For i As Integer = 0 To dgvIchiran.RowCount - 1
                If dgvIchiran.Rows(i).Cells(M4010_COLNO_SHOHINCODE).Value = _ShohinCode And
                    dgvIchiran.Rows(i).Cells(M4010_COLNO_TOKUBAIKBN).Value = _TokubaiKbn And
                    dgvIchiran.Rows(i).Cells(M4010_COLNO_TORICODE).Value = _ToriCode And
                    dgvIchiran.Rows(i).Cells(M4010_COLNO_TEKIYOKAISIDATE).Value = _TekiyoFrDT Then
                    dgvIchiran.CurrentCell = dgvIchiran.Rows(i).Cells(M4010_COLNO_SHOHINCODE)
