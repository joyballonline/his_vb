    ...
    Private Sub PurchaseManagement_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            For index As Integer = 0 To ds2.Tables(RS).Rows.Count - 1
                DgvHistory.Rows.Add()
                DgvHistory.Rows(index).Cells("入庫番号").Value = ds2.Tables(RS).Rows(index)("入庫番号")
                ...
                DgvHistory.Rows(index).Cells("入庫数量").Value = ds2.Tables(RS).Rows(index)("入庫数量")
    ...
    Private Sub BtnRegist_Click(sender As Object, e As EventArgs) Handles BtnRegist.Click
        ...
        If errFlg Then
            ...
            For index As Integer = 0 To DgvAdd.Rows.Count() - 1
                ...
                Sql8 += "', '"
                Sql8 += DgvAdd.Rows(index).Cells("入庫数量").Value.ToString
                Sql8 += "', '"
