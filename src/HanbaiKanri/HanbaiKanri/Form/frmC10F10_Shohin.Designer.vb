...
Partial Class frmC10F10_Shohin
    ...
    Friend WithEvents lblNisugataCount As Label
    ...
    Friend WithEvents lblShohinCount As Label
    Friend WithEvents lblKBN As Label
