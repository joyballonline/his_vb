...
Public Class frmC01F30_Menu
    ...
    Public Sub New(ByRef prmRefMsgHd As UtilMsgHandler, ByRef prmRefLangHd As UtilLangHandler, ByRef prmRefDbHd As UtilDBIf)
        ...
        Timer1.Interval = 5 * 60 * 1000 'StartUp._iniVal.poolingtime
        Timer1.Start()
    ...
    Private Sub InitializeComponent()
        ...
        Me.gbH16 = New System.Windows.Forms.GroupBox()
        ...
        Me.TableLayoutPanel28.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 25.0!))
        Me.TableLayoutPanel28.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 25.0!))
        Me.TableLayoutPanel28.Controls.Add(Me.gbH16, 0, 0)
        ...
        'gbH16
        '
        Me.gbH16.Dock = System.Windows.Forms.DockStyle.Fill
        Me.gbH16.Location = New System.Drawing.Point(631, 3)
        Me.gbH16.Name = "gbH16"
        Me.gbH16.Size = New System.Drawing.Size(308, 422)
        Me.gbH16.TabIndex = 34
        Me.gbH16.TabStop = False
        '
        'gbH15
        '
...
"
        ...
        Select Case selectID
           ...
           '-----------------------------------支払管理（H12）
            ...
            Case CommonConst.MENU_H1520  '為替レート
                ...
                Me.Hide()
            '-----------------------------------データ管理（H16）
            Case CommonConst.MENU_H1610  '受注進捗状況
                Dim openForm As Form = Nothing
                Dim Status As String = CommonConst.STATUS_VIEW
                openForm = New OrderProgress(_msgHd, _db, _langHd, Me, Status)
                openForm.Show()
                Me.Hide()
    ...
    <DllImport("user32")>
    Public Shared Function GetLastInputInfo(ByRef x As LASTINPUTINFO) As <MarshalAs(UnmanagedType.Bool)> Boolean
        ' Leave the body of the function empty.
    End Function

    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick

        Dim x As LASTINPUTINFO
        Dim i As Integer
        ...
        If i > StartUp._iniVal.timeout Then
            Dim m As System.Threading.Mutex = New System.Threading.Mutex(False, "HanbaiKanri")
            m.ReleaseMutex()
            m.Close()
            Application.Restart()
        Else
            'MessageBox.Show(i.ToString, "B", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
