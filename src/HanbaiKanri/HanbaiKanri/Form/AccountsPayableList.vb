...
Public Class AccountsPayableList
        ...
        If Status = "EXCLUSION" Then
            ...
            Try
                ...
                For index As Integer = 0 To ds.Tables(RS).Rows.Count - 1
                    ...
                    DgvBilling.Rows(index).Cells("買掛金額計").Value = ds.Tables(RS).Rows(index)("買掛金額計")
                    DgvBilling.Rows(index).Cells("買掛残高").Value = ds.Tables(RS).Rows(index)("買掛残高")
    ...
    Private Sub BtnPurchaseSearch_Click(sender As Object, e As EventArgs) Handles BtnAPSearch.Click
        ...
        Try
            ...
            Else
                ...
                End If
            End If
            If TxtAPDate1.Text = "" Then
                If TxtAPDate2.Text = "" Then
                Else
                    If count > 0 Then
                        Sql += " AND "
                        Sql += "買掛日"
            ...
            Else
                ...
                End If
            End If
            If TxtAPNo1.Text = "" Then
                If TxtAPNo2.Text = "" Then
                Else
                    If count > 0 Then
                        Sql += " AND "
                        Sql += "買掛番号"
    ...
    Private Sub BtnBillingView_Click(sender As Object, e As EventArgs) Handles BtnAPView.Click
        ...
        Dim No As String = DgvBilling.Rows(RowIdx).Cells("発注番号").Value
        Dim Suffix As String = DgvBilling.Rows(RowIdx).Cells("発注番号枝番").Value
    ...
    Private Sub BtnBillingCancel_Click(sender As Object, e As EventArgs) Handles BtnAPCancel.Click
        ...
        Sql1 += " 買掛番号"
        Sql1 += "='"
        Sql1 += DgvBilling.Rows(DgvBilling.CurrentCell.RowIndex).Cells("買掛番号").Value
        Sql1 += "' "
