...
Public Class InventoryRegistrationBulk
    ...
    Private Sub outputExcel(ByRef prmkikeData As System.Data.DataTable)
        ...
        Try
            ...
            sfd.FileName = "InventoryRegistrationBulkList_" & DateTime.Now.ToString("yyyyMMddHHmm") & ".xlsx"
            ...
            If sfd.ShowDialog() = DialogResult.OK Then
                ...
                '雛形ファイル名
                Dim sHinaFile As String = sHinaPath & "\" & "InventoryRegistrationBulkList.xlsx"
