...
Public Class OrderList
    ...
    Private Sub MstHanyoue_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If OrderStatus = "SALES" Then
            ...
            BtnSales.Location = New Point(997, 649)
