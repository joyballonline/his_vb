...
Partial Class ARScheduledCollectionDateList
    ...
    Private Sub InitializeComponent()
        ...
        Me.回収期日 = New System.Windows.Forms.DataGridViewTextBoxColumn()
        ...
        '回収期日
        '
        Me.回収期日.HeaderText = "回収期日"
        Me.回収期日.Name = "回収期日"
        Me.回収期日.ReadOnly = True
        '
        '得意先名
        '
        ...
        Me.Name = "ARScheduledCollectionDateList"
    ...
    Friend WithEvents 回収期日 As DataGridViewTextBoxColumn
