...
Public Class InventoryControlTable
    ...
    Private Sub setListHd()
        ...
        If frmC01F10_Login.loginValue.Language = CommonConst.LANG_KBN_ENG Then
            ...
            DgvList.Columns.Add("入庫数量", "Quantity")
            DgvList.Columns.Add("入庫単価", "UnitPrice")
            DgvList.Columns.Add("出庫数量", "Quantity")
            DgvList.Columns.Add("出庫単価", "UnitPrice")
        ...
        Else
            ...
            DgvList.Columns.Add("入庫数量", "数量")
            DgvList.Columns.Add("入庫単価", "単価")
            DgvList.Columns.Add("出庫数量", "数量")
            DgvList.Columns.Add("出庫単価", "単価")
