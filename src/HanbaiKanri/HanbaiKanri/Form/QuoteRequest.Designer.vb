...
Partial Class QuoteRequest
    ...
    Private Sub InitializeComponent()
        ...
        Me.仕入区分 = New System.Windows.Forms.DataGridViewComboBoxColumn()
        ...
        Me.DgvItemList.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.No, Me.仕入区分, Me.メーカー, Me.品名, Me.型式, Me.数量, Me.単位, Me.仕入先, Me.仕入単価, Me.間接率, Me.間接費, Me.仕入金額, Me.売単価, Me.売上金額, Me.粗利額, Me.粗利率, Me.リードタイム, Me.備考})
        ...
        Me.仕入区分.Items.AddRange(New Object() {"仕入", "在庫", "サービス"})
        Me.仕入区分.Name = "仕入区分"
        Me.仕入区分.Resizable = System.Windows.Forms.DataGridViewTriState.[True]
        Me.仕入区分.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic
        '
        'メーカー
        '
        ...
        Me.粗利率.DefaultCellStyle = DataGridViewCellStyle27
    ...
    Friend WithEvents 仕入区分 As DataGridViewComboBoxColumn
