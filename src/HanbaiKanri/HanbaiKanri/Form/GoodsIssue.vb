...
Public Class GoodsIssue
    ...
    Private Sub PurchaseManagement_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If frmC01F10_Login.loginValue.Language = "ENG" Then
            ...
            LblGoodsIssueDate.Text = "SalesDate"
        ...
        Try
            ...
            If frmC01F10_Login.loginValue.Language = "ENG" Then
                ...
                DgvHistory.Columns.Add("出庫番号", "GoodsIssueNumber")
                ...
                DgvHistory.Columns.Add("出庫数量", "GoodsIssueQuantity")
            ...
            If frmC01F10_Login.loginValue.Language = "ENG" Then
                ...
                DgvAdd.Columns.Add("出庫数量", "GoodsIssueQuantity")
            ...
            For index As Integer = 0 To ds3.Tables(RS).Rows.Count - 1
                ...
                Else
                    ...
                    DgvAdd.Rows(DgvAdd.Rows.Count - 1).Cells("出庫数量").Value = 0
    ...
    Private Sub BtnRegist_Click(sender As Object, e As EventArgs) Handles BtnRegist.Click
        ...
        If errFlg Then
            ...
            For index As Integer = 0 To DgvAdd.Rows.Count() - 1
                ...
                Sql8 += "', '"
                Sql8 += DgvAdd.Rows(index).Cells("出庫数量").Value.ToString
                Sql8 += "', '"
                ...
                Sql8 += ", "
                Sql8 += "更新日"
                If DgvAdd.Rows(index).Cells("出庫数量").Value > 0 Then
                    _db.executeDB(Sql8)
                End If
            Next
