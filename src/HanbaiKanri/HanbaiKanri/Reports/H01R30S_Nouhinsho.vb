...
Public Class H01R30S_Nouhinsho

    Public _db As UtilDBIf
    Public _parentreport As H01R30_Nouhinsho
    ...
    'レポートスタート
    '---------------------------------------------------------------------------------
    Private Sub H01R30S_Nouhinsho_ReportStart(sender As Object, e As EventArgs) Handles MyBase.ReportStart
        RS = Me.DataMember
        _ds = Me.DataSource
    End Sub
    ...
    'データイニシャライズ
    '---------------------------------------------------------------------------------
    Private Sub H01R30S_Nouhinsho_DataInitialize(sender As Object, e As EventArgs) Handles MyBase.DataInitialize
    ...
    'フェッチデータ
    '---------------------------------------------------------------------------------
    Private Sub H01R30S_Nouhinsho_FetchData(sender As Object, eArgs As FetchEventArgs) Handles MyBase.FetchData
        'Try
    ...
    'レポートエンド
    '---------------------------------------------------------------------------------
    Private Sub H01R30S_Nouhinsho_ReportEnd(sender As Object, e As EventArgs) Handles MyBase.ReportEnd
