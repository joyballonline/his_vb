...
Public Class CommonConst
    ...
    Public Const MENU_H1170 As String = "H1170"           '買掛一括登録
    ...
    Public Const MENU_H1620 As String = "H1620"           '発注進捗状況
    ...
    Public Const CI_ID As String = "id-ID"               'カルチャー インドネシア
