...
Namespace Combo
    ...
    '  履歴  名前          日  付      マーク      内容
    '-------------------------------------------------------------------------------
    '  (1)   Jun.Takagi    2006/04/22             新規
    '  (2)   Jun.Takagi    2006/06/15             getRelationObjを追加
    '-------------------------------------------------------------------------------
    Public Class UtilComboBoxHandler
        ...
        '   ●メソッド戻り値 ：なし
        '   ●発生例外       ：なし
        '                                               2006.04.22 Created By Jun.Takagi
        '-------------------------------------------------------------------------------
        ''' <summary>
        ...
        '                                               2006.06.15 Created By Jun.Takagi
        '-------------------------------------------------------------------------------
        ''' <summary>
        ''' コード取得 現在選択されている項目の項目(コード)を取得する
        ''' </summary>
    ...
    '-------------------------------------------------------------------------------
    '  (1)   Jun.Takagi    2006/04/22             新規
    '  (2)   Jun.Takagi    2006/06/15             getRelationObj用にメンバーを追加
    '-------------------------------------------------------------------------------
    ''' <summary>
    ...
    Public Class UtilCboVO
        ...
        Private _obj As Object  '2006.06.15 add by takagi
        ...
        '-->2006.06.15 add start by takagi
        ''' <summary>
